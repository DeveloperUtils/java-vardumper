 ...
 */
abstract class ContainerElementFormatter<PARENT extends IElementFormatter> extends ElementFormatter<PARENT> implements IContainerElementFormatter {
    ...
    public IArrayFormatter openArray(Object[] aObjects) {
        return fFactory.createArrayFormatter(aObjects, fBuffer, getIndentionLevel(), this);
    }

    @Override
    public IArrayFormatter openArray(Collection<?> aCollection) {
        return fFactory.createArrayFormatter(aCollection, fBuffer, getIndentionLevel(), this);
    }

    @Override
    public IMapFormatter openMap(Map<?, ?> aMap) {
        return fFactory.createMapFormatter(aMap, fBuffer, getIndentionLevel(), this);
    }

    @Override
    public IObjectFormatter openObject(Object aObject) {
        return fFactory.createObjectFormatter(aObject, fBuffer, getIndentionLevel(), this);
    }

    @Override
    public IPrimitiveFormatter openPrimitive() {
        return fFactory.createPrimitiveFormatter(fBuffer, getIndentionLevel(), this);
    }
}
